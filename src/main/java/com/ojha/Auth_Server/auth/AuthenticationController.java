...
public class AuthenticationController {
    ...
    public ResponseEntity<GlobalResponse<RegistrationResponse>> confirm(@RequestParam String email,
    ...
    public ResponseEntity<GlobalResponse<RegistrationResponse>> confirmForgotPassCode(@RequestParam String email,
                                                                                      @RequestParam String token,
                                                                                      HttpServletRequest httpServletRequest){
        try {
    ...
    public ResponseEntity<GlobalResponse<RegistrationResponse>> processForgotPassword(@RequestParam String email,
    ...
    public ResponseEntity<GlobalResponse<RegistrationResponse>> getLoggedInUser(HttpServletRequest httpServletRequest) {
        try {
            RegistrationResponse registrationResponse = authenticationService.getLoggedInUser(httpServletRequest);
            GlobalResponse<RegistrationResponse> globalResponse = GlobalResponse.<RegistrationResponse>builder()
                    .data(registrationResponse)
                    .status(HttpStatus.OK.value())
                    .path(httpServletRequest.getRequestURI())
